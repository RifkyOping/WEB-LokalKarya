...
<body class="bg-gray-50 font-sans antialiased text-gray-900">
    ...
    <section class="py-14 text-center max-w-4xl mx-auto px-4 animate-fade-in-up">
        ...
        <form action="#" method="GET"
            ...
            <div class="relative shrink-0">
                <select name="filter_type"
                    ...
                    <option value="judul">Judul Jasa</option>
                    <option value="kategori">Kategori</option>
                    <option value="seller">Nama Kreator</option>
                </select>
                <svg class="w-4 h-4 text-gray-500 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none"
        ...
        <div class="flex flex-wrap justify-center gap-3" id="filter-container">
            <button
                class="filter-btn bg-blue-600 text-white px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-transparent">Semua</button>
            <button
                class="filter-btn bg-white text-gray-600 hover:bg-gray-50 px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-gray-200">UI/UX</button>
            <button
                class="filter-btn bg-white text-gray-600 hover:bg-gray-50 px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-gray-200">Desain
                Grafis</button>
            <button
                class="filter-btn bg-white text-gray-600 hover:bg-gray-50 px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-gray-200">Video
                Editing</button>
            <button
                class="filter-btn bg-white text-gray-600 hover:bg-gray-50 px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-gray-200">Fotografi</button>
        </div>
    </section>
    ...
    <section id="katalog" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <img src="https://placehold.co/400x300/e2e8f0/64748b?text=UI/UX" alt="UI/UX"
                    class="w-full h-48 object-cover">
                <div class="p-5">
                    <span
                        class="text-[10px] font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-2 py-1 rounded-md mb-3 inline-block">UI/UX
                        Design</span>
                    <h3 class="font-bold text-gray-900 text-base leading-tight mb-2">Desain Aplikasi Mobile Modern</h3>
                    ...
                    <div class="flex items-end justify-between mt-4 pt-4 border-t border-gray-50">
                        <div>
                            ...
                            <span class="font-bold text-lg text-gray-900">Rp150K</span>
                        </div>
                        <a href="#"
            ...
            <div
                class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <img src="https://placehold.co/400x300/e2e8f0/64748b?text=Branding" alt="Branding"
                    class="w-full h-48 object-cover">
                <div class="p-5">
                    <span
                        class="text-[10px] font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-2 py-1 rounded-md mb-3 inline-block">Branding</span>
                    <h3 class="font-bold text-gray-900 text-base leading-tight mb-2">Jasa Desain Logo & Branding</h3>
                    <div class="flex items-center gap-1 mb-4 text-sm text-gray-600">
                        <span>Anisa Putri</span>
                        <svg class="w-4 h-4 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                clip-rule="evenodd"></path>
                    ...
                    <div class="flex items-end justify-between mt-4 pt-4 border-t border-gray-50">
                        <div>
                            <span class="text-xs text-gray-500 block">Mulai dari</span>
                            <span class="font-bold text-lg text-gray-900">Rp120K</span>
                        </div>
                        <a href="#"
                            class="bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-lg text-xs font-medium transition-colors">Lihat
                            Detail</a>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buttons.forEach(button => {
                button.addEventListener('click', function() {
                    // 1. Kembalikan SEMUA tombol ke warna putih/abu-abu (Tidak Aktif)
                    buttons.forEach(btn => {
                        btn.className =
                            'filter-btn bg-white text-gray-600 hover:bg-gray-50 px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-gray-200';
                    });

                    // 2. Ubah HANYA tombol yang diklik menjadi biru (Aktif)
                    this.className =
                        'filter-btn bg-blue-600 text-white px-6 py-2 rounded-full text-sm font-medium shadow-sm border border-transparent';
                });
            });
        });
    </script>
